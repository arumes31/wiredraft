...
import { CanvasEngine, tracedRackIDs } from "./static/js/canvas.js";
...
engine.shadowDeviceBoxes = [
  { device: { id: "rear-shadow" }, x: 200, y: 200, width: 100, height: 100 },
];
...
assert.equal(engine.hitDevice({ x: 225, y: 225 }), null, "opposite-face shadows must never participate in hit testing");
...
assert.deepEqual([...tracedRackIDs({
  devices: [
    { id: "front-device", rackId: "rack-front" },
    { id: "rear-device", rackId: "rack-rear" },
  ],
